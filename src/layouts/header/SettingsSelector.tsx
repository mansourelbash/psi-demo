...
import { settingsAtom, SettingsProps } from "@/atoms/settingsAtoms"
      ...
      <div className="flex flex-col gap-2.5">
        <div className="flex gap-1">
          <Button
            ...
            variant={selectedSize == "sq-ft" ? "primary-blue" : "outline"}
            onClick={() => setSelectedSize("sq-ft")}
          >
            SQ FT
          </Button>
          <Button
            className="grow text-xs font-medium"
            variant={selectedSize == "sq-m" ? "primary-blue" : "outline"}
            onClick={() => setSelectedSize("sq-m")}
          >
            SQ M
          </Button>
        </div>
