        ...
        <div className="p-1.5 flex flex-col gap-1 col-span-10 md:col-span-7">
          <div className="space-y-[2px]">
            <div className="flex items-start justify-between gap-2">
              <div>
                <h2 className="text-[18px] font-semibold text-[#F15A22]">
                  {item?.selling_price} <span className="text-[18px]">AED</span>
                </h2>
                <h3 className="text-[16px] font-medium">{item?.property_name
                    ? item?.property_name
                        .split(" ")
            ...
            <div className="flex items-center gap-2 text-gray-600">
              ...
              {[item.city?.name, item.community?.name, item.sub_community?.name]
                .filter(Boolean)
                .join(' , ')}
              </span>
            </div>
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[12px]">{item?.built_up_area_sqft} Sqft</span>
              </div>
            </div>
          </div>

          <div className="flex flex-wrap gap-2">
            <Button variant="primary-blue" className="flex-1 font-normal h-9 px-[5px] text-[12px]">
              <Phone size={12} /> Call
            </Button>
            <Button variant="primary-blue" className="flex-1 font-normal h-9 px-[5px] text-[12px]">
